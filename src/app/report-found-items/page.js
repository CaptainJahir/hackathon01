...
const Page = () => {
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            const response = await fetch('http://localhost:4200/api/report-found', {
                method: 'POST',
                body: formData
            });
        ...
        <div className='text-black'>
            <form onSubmit={handleSubmit(onSubmit)}>
                <div className='flex flex-col w-[35vw] mx-auto mt-5 gap-2 bg-white rounded-lg px-6 py-4'>
                    <div className='text-2xl font-semibold text-center'>Report Found Items</div>
                    ...
                    <div className='flex flex-col justify-center gap-0.5'>
                        ...
                        <textarea
                            ...
                            rows={2}
                            placeholder='Description about Found Item'
                        />
                        {errors.description && (
                            <span className='text-red-500 text-sm'>
